...
from botocore.compat import get_tzinfo_options
...
from botocore.vendored.six.moves.urllib.request import getproxies
from botocore.vendored.six.moves.urllib.request import proxy_bypass
